...
This directory is managed by Membase and is the project-local knowledge base
...
platform-managed and should be refreshed from Membase updates rather than edited
in place.
